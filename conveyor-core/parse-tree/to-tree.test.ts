...
describe('ToTree', () => {
  ...
  it('handles flat object with string values', async () => {
    const tree = toTree([
      { path: ['key1'], value: 'a1' },
      { path: ['key2'], value: 'a2' },
      { path: ['key3'], value: 'a3' },
  ...
  it('handles flat object with boolean value', async () => {
    const tree = toTree([
      { path: ['key1'], value: 'a1' },
  ...
  it('handles flat object with null', async () => {
    const tree = toTree([
      { path: ['key1'], value: 'a1' },
  ...
  it('handles flat object with undefined', async () => {
    const tree = toTree([
      { path: ['key1'], value: 'a1' },
  ...
  it('handles non-empty array value', async () => {
    const tree = toTree([
      { path: ['key1'], value: 'a1' },
  ...
  it('handles non-empty object value', async () => {
    const tree = toTree([
      { path: ['key1'], value: 'a1' },
  ...
  it('handles mixed array value', async () => {
    const tree = toTree([
      { path: ['key1'], value: 'a1' },
      { path: ['key2', 0], value: 'a2' },
  ...
  // TODO
  // it('handles complex object', async () => {
  //   const tree = toTree([
  //     { path: ['key1'], value: 'a1' },
